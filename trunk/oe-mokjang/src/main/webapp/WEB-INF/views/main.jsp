...
<body  hola-ext-player="1" style="position: static;">
    ...
    <div class="container-fluid">
		...
		<div id="content">
			<a href="/login/loginForm.oe"><img id="logo" src="/resources/img/logo.png" width="275" height="95" class="box2d" style="position: absolute; left: 479.20356808517px; top: 256.986969377591px; width: 275px; transform: rotate(-36.7304909398323deg); -webkit-transform: rotate(-36.7304909398323deg) translateZ(0px);"></a><br>
		</div>
		</c:if>
		<c:if test="${sessionId.roleSeq<5}">
		<div id="content">
			<a href="/user/saintList.oe"><img id="logo" src="/resources/img/logo.png" width="275" height="95" class="box2d" style="position: absolute; left: 479.20356808517px; top: 256.986969377591px; width: 275px; transform: rotate(-36.7304909398323deg); -webkit-transform: rotate(-36.7304909398323deg) translateZ(0px);"></a><br>
		</div>
		</c:if>
		<c:if test="${sessionId.roleSeq >=5}">
		<div id="content">
			<a href="/user/list.oe"><img id="logo" src="/resources/img/logo.png" width="275" height="95" class="box2d" style="position: absolute; left: 479.20356808517px; top: 256.986969377591px; width: 275px; transform: rotate(-36.7304909398323deg); -webkit-transform: rotate(-36.7304909398323deg) translateZ(0px);"></a><br>
		</div>
		</c:if>
		<script src="http://www.google.com/uds/api?file=uds.js&amp;v=0.1" type="text/javascript"></script><script src="http://www.google.com/uds/api/search/1.0/23952f7483f1bca4119a89c020d13def/default+ko.I.js" type="text/javascript"></script>
