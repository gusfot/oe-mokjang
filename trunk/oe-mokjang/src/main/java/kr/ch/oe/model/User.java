...
public class User {
	...
	public String toString() {
		return "User [department=" + department + ", studyStatusList="
				+ studyStatusList + ", missionWorkStatusList="
				+ missionWorkStatusList + ", userId=" + userId + ", userSeq="
				+ userSeq + ", userName=" + userName + ", regDt=" + regDt
				+ ", password=" + password + ", addr=" + addr + ", cellPhone="
				+ cellPhone + ", homePhone=" + homePhone + ", job=" + job
				+ ", gender=" + gender + ", birth=" + birth + ", email="
				+ email + ", deptSeq=" + deptSeq + ", regTime=" + regTime
				+ ", roleSeq=" + roleSeq + "]";
	}
	...
	public void setStudyStatusList(List<StudyStatus> studyStatusList) {
	...
	public void setMissionWorkStatusList(
			List<MissionWorkStatus> missionWorkStatusList) {
