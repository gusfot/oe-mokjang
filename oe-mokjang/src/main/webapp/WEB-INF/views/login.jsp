...
<div id="wrapper">
    ...
    <div id="wrap">
        ...
        <div id="header-wrap">
            <div id="header">
                <h1><a href="#"><img src="/resources/images/common/logo_oneguard.png" alt="CELL PLUS 목장보고 서비스"/></a>
                </h1>
                <div class="head-info">
        ...
        <div id="container">
            ...
            <div id="contents">
                ...
                <!-- Article -->
                <div id="content">
                    <p id="cont-left-top"></p>
                    <p id="cont-left-btm"></p>
                    <p id="cont-right-top"></p>
                    <div class="cont-body">
                        ...
                        <div class="list-view form">
                            <div class="box-point2">
                                <ul>
                                    <li style="padding-top:6px;">아이디</li>
                                    <li style="text-align:left;"><input type="text"
                                                                        onkeypress="return enterLogin(event)"
                                                                        name="userId" id="userId" style=""/></li>
                                </ul>
                                <ul>
                                    <li style="padding-top:6px;">패스워드</li>
                                    <li style="text-align:left;"><input type="password"
                                                                        onkeypress="return enterLogin(event)"
                                                                        name="userPw" id="userPw" style=""/></li>
                                </ul>
                                <ul>
                                    <li style="text-align:left;">
                                        <input type="checkbox"  data-inline="true" name="checkbox-mini-0" id="checkbox-mini-0"
                                               data-mini="true">
                                        <label for="checkbox-mini-0">자동로그인</label>
                                    </li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <ul class="btn-list">
                            <a href="#" onclick="login()">
                                ...
                                <li style="position:absolute; right:0px;"><img
                                        src="/resources/images/button/btn_end.gif"></li>
                            </a>
                        </ul>
                        ...
                        <ul class="btn-list2">
                            <a href="#">
                                ...
                                <li style="position:absolute; right:0px;"><img
                                        src="/resources/images/button/btn_end2.gif"></li>
                            </a>
                        </ul>
                        <ul class="btn-list2">
                            <a href="#">
