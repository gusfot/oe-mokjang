	...
	<div id="wrap">
		...
		<div id="container">
			...
			<div id="contents">
				...
				<div id="content">					
					<div class="cont-body">
						<div class="cont-tit"><h4 class="h4">박현아 목장</h4></div>
						<div class="cont-tit"><h5 class="h5">목장원</h5></div>
						<div class="list-wrap">							
							<!-- List -->
							<div class="list-view">
								<table>
					   ...
					   <c:choose>
						...
						<div class="cont-tit"><h5 class="h5">파송목장</h5></div>
						<div class="list-wrap">							
							<!-- List -->
							<div class="list-view">
								<table>
								<colgroup>
									...
									<tr>
										...
										<td align="center"><a href="#" class="btn type6"><span>보기</span></a> </td>
