							...
							<tbody>
								<c:forEach var="user" items="${mokjangUsers}" varStatus="i" >
									<tr>
										...
										<td><label class="attend_chk"><input type="checkbox" data-mini="true" name="reports[${i.index}].mokjangYn" value="1" >참석</label></td>
										<td><label class="attend_chk"><input type="checkbox" data-mini="true" name="reports[${i.index}].sundayYn" value="1" >참석</label></td>
										<td><label class="attend_chk"><input type="checkbox" data-mini="true">참석</label></td>
										<td><label class="attend_chk"><input type="checkbox" data-mini="true">참석</label></td>
										<td><label class="attend_chk"><input type="checkbox" data-mini="true">참석</label></td>
										<td><label class="attend_chk"><input type="checkbox" data-mini="true">참석</label></td>
										<td><label class="attend_chk"><input type="checkbox" data-mini="true">참석</label></td>							
