			...
			<div class="header_wrap">
				<div class="header">
					...
					<div class="header_week">
						...
						<div class="week_picker" style="width:50%;"><input type="week" data-clear-btn="true" name="week-2" id="week-2" value="<fmt:formatDate value="${date}" pattern="yyyy" />-W${thisWeeks-1 }"></div>
