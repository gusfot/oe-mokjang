...
function paging(page, pageSize, totalNumOfItems){ 
	...
	html += '<li ' + (page == 1 ? 'class="disabled"' : '"enable"') + '><a '+(page==1?'href="#"':' href="#'+(page-1))+'" data-page="' + (firstPage-1) + '">&lsaquo;</a></li>';
	for (var i=firstPage; i<firstPage+10; i++) {
		if (i <= totalPage)
			html += '<li ' + (page == i ? 'class="active"' : '') + '><a onclick="sheepPage('+i+')" data-page="' + i + '">' + i + '</a></li>';
		else
...
//html += '<li ' + (totalPage < firstPage+10 ? 'class="disabled"' : '"enable"') + '><a href="#" data-page="' + (firstPage+10) + '">Sdf;</a></li>';
	html += '<li ' + (page == totalPage ? 'class="disabled"' : '"enable"') + '><a '+(page == totalPage ? 'href="#"':' href="#'+(pageInt+1))+'" data-page="' + (page++) + '">&rsaquo;</a></li>';
	html += '<li><a href="#'+totalPage+'" data-page="' + totalPage + '">&raquo;</a></li>';
return html;
};
