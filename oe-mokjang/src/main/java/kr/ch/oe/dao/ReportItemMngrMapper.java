...
public interface ReportItemMngrMapper {
     ...
     * @mbggenerated Sun Mar 22 14:28:40 KST 2015
     */
    int updateByExampleSelective(@Param("record") ReportItemMngr record, @Param("example") ReportItemMngrExample example);
     ...
     * @mbggenerated Sun Mar 22 14:28:40 KST 2015
     */
    int updateByExampleWithBLOBs(@Param("record") ReportItemMngr record, @Param("example") ReportItemMngrExample example);
     ...
     * @mbggenerated Sun Mar 22 14:28:40 KST 2015
     */
    int updateByExample(@Param("record") ReportItemMngr record, @Param("example") ReportItemMngrExample example);
